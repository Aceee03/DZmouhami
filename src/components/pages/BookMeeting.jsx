const BookMeeting = () => {
    return (
        <div class="w-screen">
            <div class="relative mx-auto mt-20 mb-20 max-w-screen-lg overflow-hidden rounded-t-xl bg-red-800/60 py-32 text-center shadow-xl shadow-gray-300">
            ...
            <div class="mx-auto grid max-w-screen-lg px-6 pb-20">
                ...
                <button class="mt-8 w-56 rounded-full border-8 border-red-500 bg-red-600 px-10 py-4 text-lg font-bold text-white transition hover:translate-y-1">Book Now</button>
            </div>
        </div>
